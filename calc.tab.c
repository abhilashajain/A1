...
{
       0,    73,    73,    76,    77,    80,    81,    85,    89,    93,
      98,   109,   114,   118,   122,   126,   130
};
#endif
...
{
  "$end", "error", "$undefined", "TOK_NEG", "TOK_MUL", "TOK_INT_NUM",
  "TOK_FLOAT_TYPE", "TOK_PRINTLN", "TOK_MAIN", "TOK_ID", "TOK_EQ",
  "TOK_LCURL", "TOK_RCURL", "TOK_SEMICOLON", "TOK_LBKT", "TOK_RBKT",
  "TOK_ADD", "'{'", "'}'", "$accept", "Prog", "Stmts", "Stmt", "expr", YY_NULLPTR
};
#endif
...
{
      -6,    -5,     8,    19,   -13,    15,    -3,    10,    -4,    18,
     -13,    14,    16,     1,    21,    16,    23,   -13,    19,    20,
     -13,     0,    16,    16,    16,     1,    16,   -13,   -13,   -13,
     -13,    30,     1,     1
};
...
{
       0,     0,     0,     3,     1,     0,     0,     0,     0,     0,
      11,    12,     0,     8,     0,     0,     0,     2,     3,     0,
      12,     0,     0,     0,     0,     6,     0,     4,    13,    16,
      14,    15,    10,     9
};
...
{
      21,    14,     1,    25,    22,    22,     3,    15,     4,    18,
      30,    31,    32,    16,    33,    29,    23,    23,     9,     9,
      10,    10,    17,    19,    11,    20,     5,    -7,     6,    12,
      12,    24,    -5,    26,    22,    28,     0,     0,     0,     0,
      27
};

static const yytype_int8 yycheck[] =
{
      12,     4,     8,    15,     4,     4,    11,    10,     0,    13,
      22,    23,    24,    16,    26,    15,    16,    16,     3,     3,
       5,     5,    12,     5,     9,     9,     7,    13,     9,    14,
      14,    10,    13,    10,     4,    15,    -1,    -1,    -1,    -1,
      18
};
...
{
       0,     8,    20,    11,     0,     7,     9,    21,    22,     3,
       5,     9,    14,    23,     4,    10,    16,    12,    13,     5,
       9,    23,     4,    16,    10,    23,    10,    21,    15,    15,
      23,    23,    23,    23
};
...
#line 82 "calc.y" /* yacc.c:1646  */
    {
                setVar((yyvsp[-2].char_val),(yyvsp[0].int_val));
        }
...
#line 94 "calc.y" /* yacc.c:1646  */
    {
			...
			setVar( (yyvsp[-3].char_val) ,getVar((yyvsp[-3].char_val)) + (yyvsp[0].int_val));
...
#line 115 "calc.y" /* yacc.c:1646  */
    {	
				(yyval.int_val) = getVar((yyvsp[0].char_val));	
		}
